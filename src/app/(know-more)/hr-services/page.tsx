  ...
  return (
    <>
      ...
      <div className="lg:px-32 px-4 py-5">
        ...
        <p className="text-gray-700">Be part of a community that is creating a brighter future through education and innovation.</p>
        <p className="text-gray-700">Reach us at : <span className="text-yellow-800"><a href="mailto:info@shikshakdwar.com">info@shikshakdwar.com</a></span></p>
