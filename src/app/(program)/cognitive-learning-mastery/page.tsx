...
const CognitiveLearning: React.FC = () => {
  return (
    <>
      <Navbar /> 
      <Hero
        heading="Unlocking the Power of Cognitive Learning"
        subheading="Explore the science of cognitive learning! Enhance memory, problem-solving, and creativity with practical strategies, interactive lessons, and real-world applications for personal and professional growth. Unlock your mind’s full potential!"
        backgroundImage="/image/cognitive/banner.webp"
      />
      <CognitiveCard />
...
export default CognitiveLearning;
